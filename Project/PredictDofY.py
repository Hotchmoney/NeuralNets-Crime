...
train_main = dataframe[0:train_size,15]
test_main = dataframe[train_size:len(dataframe),15]
train_main= train_main[:,None]
test_main = test_main[:,None]
...
trainX_main = numpy.reshape(trainX_main,(trainX_main.shape[0],4,1))
testX_main = numpy.reshape(testX_main,(testX_main.shape[0],4,1))
